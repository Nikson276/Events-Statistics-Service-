...
- [ ] Обсуждение архитектуры микросервиса
- [ ] Изучение применимых паттернов (Event Sourcing, CQRS)
- [ ] Получение обратной связи по первому варианту реализации
...
- [ ] Оптимизация обработки событий и хранения данных
- [ ] Подготовка финальной документации
- [ ] Анализ возможных рисков и стратегий масштабирования
...
- Переключить синхронный дравер кафки на ассинхронный драйвер и перезамерить
- Вернуть FastAPI на один инстанс с воркерами = ядрам (не более, тут не выйграшь)
- Timeweb зарегаться и протестить на двух машинах
- Замерить кафка лаг на чтение из клихауса
